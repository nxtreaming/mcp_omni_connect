...
1. **[Follow the Quick Start guide](/getting-started/quickstart)** - Build your first agent in under 30 seconds.
2. **[Explore Core Features](/core-concepts/overview)** - Learn about memory, events, and tools.
3. **[Set up configuration](/how-to-guides/configuration)** - Learn about environment variables and agent settings.
...
**Next**: [Quick Start Guide →](/getting-started/quickstart)
