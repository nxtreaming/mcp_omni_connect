...
Through the [Event System](../core-concepts/events.mdx), you can calculate performance metrics:
...
- **Monitoring Events**: In production, pipe your [real-time events](../core-concepts/events.mdx) into ELK, Datadog, or Sentry for long-term alerting.
